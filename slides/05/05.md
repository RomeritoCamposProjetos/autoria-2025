...
### Elementos substituídos e não substituídos

* **Não substituídos**: o navegador renderiza seu próprio conteúdo (ex.: `<p>`, `<div>`)
* **Substituídos**: agem como “caixas de espaço reservado” para outro conteúdo (ex.: `<img>`)
...
* `height` e `width` não se aplicam a elementos **inline não substituídos**
